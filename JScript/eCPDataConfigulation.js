...
{        
    ...
    var _send = new Array();
    _send[0] = "cp1id=" + $("#cp1id").val();
    _send[1] = "incontractinterest=" + DelCommas("in-contract-interest");
    _send[2] = "outcontractinterest=" + DelCommas("out-contract-interest");
...
function UpdateUseContractInterest(_cp1id)
{
    ...
    _send[1] = "usecontractinterest=" + ($("input[name='use-contract-interest']:checked").val() != null ? 1 : 0);
...
function ValidateCPTabScholarship(_action)
{
    ...
    _send[4] = "majorcode=" + _program[2];
    _send[5] = "groupnum=" + _program[3];
    _send[6] = "scholarshipmoney=" + DelCommas("scholarship-money");
