...
function SearchCPTabUser()
{
    ...
    _searchValue[0] = $("#name-tab-user-hidden").val();

    BoxSearchCondition(1, _searchValue, "search-tab-user-condition");

    var _send = new Array();
    _send[0] = "name=" + $("#name-tab-user-hidden").val();
...
function SearchStudentWithResult()
{
    ...
    var _send = new Array();
    _send[0] = "studentid=" + $("#id-name-search-student").val();
    _send[1] = "faculty=" + (_faculty[0] != null ? _faculty[0] : ""); ;
    _send[2] = "programcode=" + (_program[0] != null ? _program[0] : "");
    _send[3] = "majorcode=" + (_program[2] != null ? _program[2] : "");
    _send[4] = "groupnum=" + (_program[3] != null ? _program[3] : "");
...
function SearchCPTransBreakContract()
{
    ...
    var _searchValue = new Array();
    _searchValue[0] = $("#trackingstatus-trans-break-contract-text-hidden").val();
    _searchValue[1] = $("#id-name-trans-break-contract-hidden").val();
    _searchValue[2] = (_faculty[0] != null ? _faculty[0] + " - " + _faculty[1] : "");
    _searchValue[3] = (_program[0] != null ? _program[0] + " - " + _program[1] + _groupNum : "");
    _searchValue[4] = (($("#date-start-trans-break-contract-hidden").val().length > 0) && ($("#date-end-trans-break-contract-hidden").val().length > 0) ? $("#date-start-trans-break-contract-hidden").val() + " - " + $("#date-end-trans-break-contract-hidden").val() : "");

    BoxSearchCondition(5, _searchValue, "search-trans-break-contract-condition");
    
    var _send = new Array();        
    _send[0] = "statussend=" + ($("#trackingstatus-trans-break-contract-hidden").val() == "1" ? "1" : ($("#trackingstatus-trans-break-contract-hidden").val() == "6" ? "1" : ""));
    _send[1] = "statusreceiver=" + ($("#trackingstatus-trans-break-contract-hidden").val() == "2" ? "1" : ($("#trackingstatus-trans-break-contract-hidden").val() == "3" ? "2" : ""));
    _send[2] = "statusedit=" + ($("#trackingstatus-trans-break-contract-hidden").val() == "4" ? "2" : ($("#trackingstatus-trans-break-contract-hidden").val() == "6" ? "2" : ""));
    _send[3] = "statuscancel=" + ($("#trackingstatus-trans-break-contract-hidden").val() == "5" ? "2" : ($("#trackingstatus-trans-break-contract-hidden").val() == "6" ? "2" : ""));
    _send[4] = "studentid=" + $("#id-name-trans-break-contract-hidden").val();
    ...
    _send[9] = "datestart=" + $("#date-start-trans-break-contract-hidden").val();
    _send[10] = "dateend=" + $("#date-end-trans-break-contract-hidden").val();
...
function SearchRepay()
{
    ...
    var _searchValue = new Array();
    _searchValue[0] = $("#repaystatus-trans-repay-contract-text-hidden").val();
    _searchValue[1] = $("#id-name-trans-repay-contract-hidden").val();
    _searchValue[2] = (_faculty[0] != null ? _faculty[0] + " - " + _faculty[1] : "");
    _searchValue[3] = (_program[0] != null ? _program[0] + " - " + _program[1] + _groupNum : "");
    _searchValue[4] = (($("#date-start-trans-repay-contract-hidden").val().length > 0) && ($("#date-end-trans-repay-contract-hidden").val().length > 0) ? $("#date-start-trans-repay-contract-hidden").val() + " - " + $("#date-end-trans-repay-contract-hidden").val() : "");

    BoxSearchCondition(5, _searchValue, "search-trans-repay-contract-condition");

    var _statusRepay = SetStatusRepay();
    var _send = new Array();
    _send[0] = "statusrepay=" + _statusRepay[0];
    _send[1] = "statusreply=" + _statusRepay[1];
    _send[2] = "replyresult=" + _statusRepay[2];
    _send[3] = "statuspayment=" + _statusRepay[3];
    _send[4] = "studentid=" + $("#id-name-trans-repay-contract-hidden").val();
    _send[5] = "faculty=" + (_faculty[0] != null ? _faculty[0] : "");
    _send[6] = "programcode=" + (_program[0] != null ? _program[0] : "");
    _send[7] = "majorcode=" + (_program[2] != null ? _program[2] : "");
    _send[8] = "groupnum=" + (_program[3] != null ? _program[3] : "");
    _send[9] = "datestart=" + $("#date-start-trans-repay-contract-hidden").val();
    _send[10] = "dateend=" + $("#date-end-trans-repay-contract-hidden").val();
...
function SearchPayment()
{
    ...
    var _searchValue = new Array();
    _searchValue[0] = $("#paymentstatus-trans-payment-text-hidden").val();
    _searchValue[1] = $("#id-name-trans-payment-hidden").val();
    _searchValue[2] = (_faculty[0] != null ? _faculty[0] + " - " + _faculty[1] : "");
    _searchValue[3] = (_program[0] != null ? _program[0] + " - " + _program[1] + _groupNum : "");
    //ปรับปรุงเมื่อ ๒๗/๐๓/๒๕๖๒
    //---------------------------------------------------------------------------------------------------
    _searchValue[4] = (($("#date-start-trans-repay1-reply-hidden").val().length > 0) && ($("#date-end-trans-repay1-reply-hidden").val().length > 0) ? $("#date-start-trans-repay1-reply-hidden").val() + " - " + $("#date-end-trans-repay1-reply-hidden").val() : "");
    //---------------------------------------------------------------------------------------------------

    BoxSearchCondition(5, _searchValue, "search-trans-payment-condition");

    var _send = new Array();
    _send[0] = "statuspayment=" + $("#paymentstatus-trans-payment-hidden").val();
    _send[1] = "studentid=" + $("#id-name-trans-payment-hidden").val();
    _send[2] = "faculty=" + (_faculty[0] != null ? _faculty[0] : "");
    _send[3] = "programcode=" + (_program[0] != null ? _program[0] : "");
    _send[4] = "majorcode=" + (_program[2] != null ? _program[2] : "");
    _send[5] = "groupnum=" + (_program[3] != null ? _program[3] : "");
    //ปรับปรุงเมื่อ ๒๗/๐๓/๒๕๖๒
    //---------------------------------------------------------------------------------------------------
    _send[6] = "datestart=" + $("#date-start-trans-repay1-reply-hidden").val();
    _send[7] = "dateend=" + $("#date-end-trans-repay1-reply-hidden").val();
    //---------------------------------------------------------------------------------------------------
...
function SearchReportTableCalCapitalAndInterest()
{
    ...
    var _searchValue = new Array();
    _searchValue[0] = $("#id-name-report-table-cal-capital-and-interest-hidden").val();
    _searchValue[1] = (_faculty[0] != null ? _faculty[0] + " - " + _faculty[1] : "");
    _searchValue[2] = (_program[0] != null ? _program[0] + " - " + _program[1] + _groupNum : "");

    BoxSearchCondition(3, _searchValue, "search-report-table-cal-capital-and-interest-condition");

    var _send = new Array();
    _send[0] = "studentid=" + $("#id-name-report-table-cal-capital-and-interest-hidden").val();
    _send[1] = "faculty=" + (_faculty[0] != null ? _faculty[0] : "");
    _send[2] = "programcode=" + (_program[0] != null ? _program[0] : "");
    _send[3] = "majorcode=" + (_program[2] != null ? _program[2] : "");
    _send[4] = "groupnum=" + (_program[3] != null ? _program[3] : "");
...
function SearchReportStepOfWork()
{
    ...
    var _searchValue = new Array();
    _searchValue[0] = $("#stepofworkstatus-report-step-of-work-text-hidden").val();
    _searchValue[1] = $("#id-name-report-step-of-work-hidden").val();
    _searchValue[2] = (_faculty[0] != null ? _faculty[0] + " - " + _faculty[1] : "");
    _searchValue[3] = (_program[0] != null ? _program[0] + " - " + _program[1] + _groupNum : "");
    ...
    var _send = new Array();
    _send[0] = "statusstepofwork=" + $("#stepofworkstatus-report-step-of-work-hidden").val();
    _send[1] = "studentid=" + $("#id-name-report-step-of-work-hidden").val();
    _send[2] = "faculty=" + (_faculty[0] != null ? _faculty[0] : "");
    _send[3] = "programcode=" + (_program[0] != null ? _program[0] : "");
    _send[4] = "majorcode=" + (_program[2] != null ? _program[2] : "");
    _send[5] = "groupnum=" + (_program[3] != null ? _program[3] : "");
...
function SearchReportStepOfWorkOnStatisticRepayByProgram()
{
    ...
    var _program = $("#program-report-step-of-work-on-statistic-repay-by-program-hidden").val().split(";");
    var _send = new Array();
    _send[0] = "acadamicyear=" + $("#acadamicyear-hidden").val();
    _send[1] = "studentid=" + $("#id-name-search-report-step-of-work").val();
    _send[2] = "faculty=" + (_faculty[0] != null ? _faculty[0] : ""); ;
    _send[3] = "programcode=" + (_program[0] != null ? _program[0] : "");
    _send[4] = "majorcode=" + (_program[2] != null ? _program[2] : "");
    _send[5] = "groupnum=" + (_program[3] != null ? _program[3] : "");
...
function SearchReportStudentOnStatisticContractByProgram(_searchTab)
{
    ...
    var _send = new Array();
    _send[0] = "acadamicyear=" + $("#acadamicyear-hidden").val();
    _send[1] = "studentid=" + $("#id-name-search-report-student-contract").val();
    _send[2] = "faculty=" + (_faculty[0] != null ? _faculty[0] : ""); ;
    _send[3] = "programcode=" + (_program[0] != null ? _program[0] : "");
    _send[4] = "majorcode=" + (_program[2] != null ? _program[2] : "");
    _send[5] = "groupnum=" + (_program[3] != null ? _program[3] : "");
    _send[6] = "searchtab=" + _searchTab;
...
function SearchReportNoticeRepayComplete()
{
    ...
    var _searchValue = new Array();
    _searchValue[0] = $("#id-name-report-notice-repay-complete-hidden").val();
    _searchValue[1] = (_faculty[0] != null ? _faculty[0] + " - " + _faculty[1] : "");
    _searchValue[2] = (_program[0] != null ? _program[0] + " - " + _program[1] + _groupNum : "");
    ...
    var _send = new Array();
    _send[0] = "studentid=" + $("#id-name-report-notice-repay-complete-hidden").val();
    _send[1] = "faculty=" + (_faculty[0] != null ? _faculty[0] : "");
    _send[2] = "programcode=" + (_program[0] != null ? _program[0] : "");
    _send[3] = "majorcode=" + (_program[2] != null ? _program[2] : "");
    _send[4] = "groupnum=" + (_program[3] != null ? _program[3] : "");
...
function SearchReportNoticeClaimDebt()
{
    ...
    var _searchValue = new Array();
    _searchValue[0] = $("#id-name-report-notice-claim-debt-hidden").val();
    _searchValue[1] = (_faculty[0] != null ? _faculty[0] + " - " + _faculty[1] : "");
    _searchValue[2] = (_program[0] != null ? _program[0] + " - " + _program[1] + _groupNum : "");
    ...
    var _send = new Array();
    _send[0] = "studentid=" + $("#id-name-report-notice-claim-debt-hidden").val();
    _send[1] = "faculty=" + (_faculty[0] != null ? _faculty[0] : "");
    _send[2] = "programcode=" + (_program[0] != null ? _program[0] : "");
    _send[3] = "majorcode=" + (_program[2] != null ? _program[2] : "");
    _send[4] = "groupnum=" + (_program[3] != null ? _program[3] : "");
...
function SearchReportStatisticPaymentByDate()
{
    ...
    var _searchValue = new Array();
    _searchValue[0] = $("#id-name-report-statistic-payment-by-date-hidden").val();
    _searchValue[1] = (_faculty[0] != null ? _faculty[0] + " - " + _faculty[1] : "");
    _searchValue[2] = (_program[0] != null ? _program[0] + " - " + _program[1] + _groupNum : "");
    _searchValue[3] = (_formatPayment[0] != null ? _formatPayment[1] : "");
    _searchValue[4] = (($("#date-start-report-statistic-payment-by-date-hidden").val().length > 0) && ($("#date-end-report-statistic-payment-by-date-hidden").val().length > 0) ? $("#date-start-report-statistic-payment-by-date-hidden").val() + " - " + $("#date-end-report-statistic-payment-by-date-hidden").val() : "");

    BoxSearchCondition(5, _searchValue, "search-report-statistic-payment-by-date-condition");

    var _send = new Array();
    _send[0] = "studentid=" + $("#id-name-report-statistic-payment-by-date-hidden").val();
    _send[1] = "faculty=" + (_faculty[0] != null ? _faculty[0] : "");
    _send[2] = "programcode=" + (_program[0] != null ? _program[0] : "");
    _send[3] = "majorcode=" + (_program[2] != null ? _program[2] : "");
    _send[4] = "groupnum=" + (_program[3] != null ? _program[3] : "");
    _send[5] = "formatpayment=" + (_formatPayment[0] != null ? _formatPayment[0] : "");
    _send[6] = "datestart=" + $("#date-start-report-statistic-payment-by-date-hidden").val();
    _send[7] = "dateend=" + $("#date-end-report-statistic-payment-by-date-hidden").val();
...
function SearchReportEContract()
{
    ...
    var _searchValue = new Array();
    _searchValue[0] = $("#acadamicyear-report-e-contract-hidden").val();
    _searchValue[1] = $("#id-name-report-e-contract-hidden").val();
    _searchValue[2] = (_faculty[0] != null ? _faculty[0] + " - " + _faculty[1] : "");
    _searchValue[3] = (_program[0] != null ? _program[0] + " - " + _program[1] + _groupNum : "");
    ...
    var _send = new Array();
    _send[0] = "acadamicyear=" + $("#acadamicyear-report-e-contract-hidden").val();
    _send[1] = "studentid=" + $("#id-name-report-e-contract-hidden").val();
    _send[2] = "faculty=" + (_faculty[0] != null ? _faculty[0] : "");
    _send[3] = "programcode=" + (_program[0] != null ? _program[0] : "");
    _send[4] = "majorcode=" + (_program[2] != null ? _program[2] : "");
    _send[5] = "groupnum=" + (_program[3] != null ? _program[3] : "");
...
function SearchReportDebtorContract()
{
    ...
    var _searchValue = new Array();
    _searchValue[0] = (($("#date-start-report-debtor-contract-hidden").val().length > 0) && ($("#date-end-report-debtor-contract-hidden").val().length > 0) ? $("#date-start-report-debtor-contract-hidden").val() + " - " + $("#date-end-report-debtor-contract-hidden").val() : "");

    BoxSearchCondition(1, _searchValue, "search-report-debtor-contract-condition");

    var _send = new Array();
    _send[0] = "reportorder=" + _reportOrder;
    _send[1] = "datestart=" + $("#date-start-report-debtor-contract-hidden").val();
    _send[2] = "dateend=" + $("#date-end-report-debtor-contract-hidden").val();
...
function SearchReportDebtorContractByProgram()
{
    ...
    var _searchValue = new Array();
    _searchValue[0] = (($("#date-start-report-debtor-contract-hidden").val().length > 0) && ($("#date-end-report-debtor-contract-hidden").val().length > 0) ? $("#date-start-report-debtor-contract-hidden").val() + " - " + $("#date-end-report-debtor-contract-hidden").val() : "");
    _searchValue[1] = $("#id-name-report-debtor-contract-by-program-hidden").val();
    _searchValue[2] = (_formatPayment[0] != null ? _formatPayment[1] : "");
    ...
    _send[1] = "datestart=" + $("#date-start-report-debtor-contract-hidden").val();
    _send[2] = "dateend=" + $("#date-end-report-debtor-contract-hidden").val();
    _send[3] = "studentid=" + $("#id-name-report-debtor-contract-by-program-hidden").val();
...
function SearchStudentDebtorContractByProgram()
{
    ...
    _send[1] = "datestart=" + $("#date-start-report-debtor-contract-hidden").val();
    _send[2] = "dateend=" + $("#date-end-report-debtor-contract-hidden").val();
    _send[3] = "studentid=" + $("#id-name-report-debtor-contract-by-program").val();
    _send[4] = "faculty=" + (_faculty[0] != null ? _faculty[0] : ""); ;
    _send[5] = "programcode=" + (_program[0] != null ? _program[0] : "");
    _send[6] = "majorcode=" + (_program[2] != null ? _program[2] : "");
    _send[7] = "groupnum=" + (_program[3] != null ? _program[3] : "");
