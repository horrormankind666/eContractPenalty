...
function Signin()
{
    ...
    LoadAjax(_send.join("&"), "Handler/eCPHandler.ashx", "POST", true, true, function (_result) {
        ...
        switch (_dataError[1])
        {
            case "1": { _error = true; _msg = "ไม่พบผู้ใช้งานนี้"; _focus = "username"; break; }
        }
...
function GoToPage(_section, _order)
{
    ...
    if (_order != 0 && _section == 1) //เจ้าหน้าที่กองกฏหมาย
    {
        switch (_order)
        {
            case 1  : { _pid = 1; _area = "sec"; break; } //หน้าแรก
            case 2  : { _pid = 2; _area = "sec"; break; } //บัญชีผู้ใช้งาน
            case 3  : { _pid = 3; _area = "sec"; break; } //ตั้งค่าระบบ - กำหนดหลักสูตรที่ให้มีการทำสัญญาการศึกษา
            case 4  : { _pid = 4; _area = "sec"; break; } //ตั้งค่าระบบ - เงื่อนไขการคิดระยะเวลาตามสัญญาและสูตรคำนวณเงินชดใช้ตามสัญญา
            case 5  : { _pid = 5; _area = "sec"; break; } //ตั้งค่าระบบ - กำหนดดอกเบี้ยจากการผิดนัดชำระ
            case 6  : { _pid = 6; _area = "sec"; break; } //ตั้งค่าระบบ - เกณฑ์การชดใช้ตามสัญญา
            case 7  : { _pid = 7; _area = "sec"; break; } //ตั้งค่าระบบ - กำหนดทุนการศึกษาแต่ละหลักสูตร
            case 8  : { _pid = 8; _area = "sec"; break; } //รับแจ้งนักศึกษาผิดสัญญา
            case 9  : { _pid = 9; _area = "sec"; break; } //บันทึกการชำระหนี้ / ดอกเบี้ย
            case 10 : { _pid = 10; _area = "sec"; break; } //รายงาน - สถานะขั้นตอนการดำเงินงานของผู้ผิดสัญญา
            case 11 : { _pid = 11; _area = "sec"; break; } //รายงาน - ตารางคำนวณเงินต้นและดอกเบี้ย
            case 12 : { _pid = 12; _area = "sec"; break; } //รายงาน - สถิติการชำระหนี้ของผู้ผิดสัญญา
            case 13 : { _pid = 13; _area = "sec"; break; } //รายงาน - หนังสือทวงถามผู้ผิดสัญญาและผู้ค้ำประกัน
            case 14 : { _pid = 14; _area = "sec"; break; } //รายงาน - สถิติการทำสัญญาและการผิดสัญญาของนักศึกษา
            case 15 : { _pid = 15; _area = "sec"; break; } //รายงาน - สถิติการชำระหนี้ตามช่วงวันที่
            case 16 : { _pid = 16; _area = "sec"; break; } //รายงาน - เอกสารสัญญาการเป็นนักศึกษา
            case 17 : { _pid = 17; _area = "sec"; break; } //รายงาน - ลูกหนี้ผิดสัญญาการศึกษาที่ยอมรับสภาพหนี้
            case 18 : { _pid = 18; _area = "sec"; break; } //รายงาน - การรับชำระเงินจากลูกหนี้ผิดสัญญาการศึกษาที่ยอมรับสภาพหนี้
            case 19 : { _pid = 19; _area = "sec"; break; } //รายงาน - ลูกหนี้ผิดสัญญาการศึกษาคงค้างที่ยอมรับสภาพหนี้
        }
    }

    if (_order != 0 && _section == 2) //เจ้าหน้าที่กองบริหารการศึกษา
    {
        switch (_order)
        {
            case 1 : { _pid = 1; _area = "sec"; break; } //หน้าแรก
            case 2 : { _pid = 2; _area = "sec"; break; } //บัญชีผู้ใช้งาน
            case 3 : { _pid = 3; _area = "sec"; break; } //แจ้งนักศึกษาผิดสัญญา
            case 4 : { _pid = 4; _area = "sec"; break; } //รายงาน - สถานะขั้นตอนการดำเงินงานของผู้ผิดสัญญา
            case 5 : { _pid = 5; _area = "sec"; break; } //รายงาน - สถิติการชำระหนี้ของผู้ผิดสัญญา
            case 6 : { _pid = 6; _area = "sec"; break; } //รายงาน - หนังสือแจ้งต้นสังกัดและคณะกรรมการพิจารณา
            case 7 : { _pid = 7; _area = "sec"; break; } //รายงาน - สถิติการทำสัญญาและการผิดสัญญาของนักศึกษา
            case 8 : { _pid = 8; _area = "sec"; break; } //รายงาน - สถิติการชำระหนี้ตามช่วงวันที่
            case 9 : { _pid = 9; _area = "sec"; break; } //รายงาน - เอกสารสัญญาการเป็นนักศึกษา
        }
    }

    if (_order != 0 && _section == 3) //เจ้าหน้าที่กองคลัง
    {
        switch (_order)
        {
            case 1 : { _pid = 1; _area = "sec"; break; } //หน้าแรก
            case 2 : { _pid = 2; _area = "sec"; break; } //รายงาน - ลูกหนี้ผิดสัญญาการศึกษามหาวิทยาลัยมหิดล
            case 3 : { _pid = 3; _area = "sec"; break; } //รายงาน - การรับชำระเงินจากลูกหนี้ ตามการผิดสัญญาการศึกษามหาวิทยาลัยมหิดล
            case 4 : { _pid = 4; _area = "sec"; break; } //รายงาน - ลูกหนี้ผิดสัญญาการศึกษามหาวิทยาลัยมหิดลคงค้าง
        }
    }
...
function LoadPage(_area, _section, _pid)
{
    ...
    LoadAjax(_send.join("&"), "Handler/eCPHandler.ashx", "POST", true, true, function (_result) {
        ...
        if (_section == 1)
        {
            switch (_pid)
            {
                case 2  : { OpenTab("link-tab1-cp-tab-user", "#tab1-cp-tab-user", "", true, "", "", ""); break; }
                case 8  : { OpenTab("link-tab1-cp-trans-require-contract", "#tab1-cp-trans-require-contract", "", true, "", "", ""); break; }
                case 9  : { OpenTab("link-tab1-cp-trans-payment", "#tab1-cp-trans-payment", "", true, "", "", ""); break; }
                case 10 : { SetMsgLoading("กำลังโหลด..."); SearchReportStepOfWork(); break ;}
                case 11 : { OpenTab("link-tab1-cp-report-table-cal-capital-and-interest", "#tab1-cp-report-table-cal-capital-and-interest", "", true, "", "", ""); break; }
                case 12 : { OpenTab("link-tab1-cp-report-statistic-repay", "#tab1-cp-report-statistic-repay", "", true, "", "", ""); break; }
                case 13 : { SetMsgLoading("กำลังโหลด..."); SearchReportNoticeClaimDebt(); break; }
                case 14 : { OpenTab("link-tab1-cp-report-statistic-contract", "#tab1-cp-report-statistic-contract", "", true, "", "", ""); break; }
                case 15 : { SetMsgLoading("กำลังโหลด..."); SearchReportStatisticPaymentByDate(); break; }
                case 16 : { SetMsgLoading("กำลังโหลด..."); SearchReportEContract(); break; }
                case 17 :
                case 18 :
                case 19 : { OpenTab("link-tab1-cp-report-debtor-contract", "#tab1-cp-report-debtor-contract", "", true, "", "", ""); break; }
            }
        }
        ...
        if (_section == 2)         
        {
            ...
            {
                case 2 : { OpenTab("link-tab1-cp-tab-user", "#tab1-cp-tab-user", "", true, "", "", ""); break; }
                case 3 : { OpenTab("link-tab1-cp-trans-break-contract", "#tab1-cp-trans-break-contract", "", true, "", "", ""); break; }
                case 4 : { SetMsgLoading("กำลังโหลด..."); SearchReportStepOfWork(); break; }
                case 5 : { OpenTab("link-tab1-cp-report-statistic-repay", "#tab1-cp-report-statistic-repay", "", true, "", "", ""); break; }
                case 6 : { SetMsgLoading("กำลังโหลด..."); SearchReportNoticeRepayComplete(); break; }
                case 7 : { OpenTab("link-tab1-cp-report-statistic-contract", "#tab1-cp-report-statistic-contract", "", true, "", "", ""); break; }
                case 8 : { SetMsgLoading("กำลังโหลด..."); SearchReportStatisticPaymentByDate(); break; }
                case 9 : { SetMsgLoading("กำลังโหลด..."); SearchReportEContract(); break; }
            }
        }
        ...
        if (_section == 3)
        {
            switch (_pid)
            {
                case 2 :
                case 3 :
                case 4 : { OpenTab("link-tab1-cp-report-debtor-contract", "#tab1-cp-report-debtor-contract", "", true, "", "", ""); break; }
            }
        }
...
{
    var _send = new Array();
    _send[0] = "action=combobox";
    _send[1] = "list=" + _listData;
    _send[2] = _param;
...
function LoadList(_listData, _recordCountID, _listID, _navPageID)
{
    ...
    LoadAjax(_send.join("&"), "Handler/eCPHandler.ashx", "POST", true, true, function (_result) {
        ...
        if (_navPageID.length > 0) $("#" + _navPageID).html(_dataPageNav[1]);
    });
}

function InitTab(_subTab)
{
    if (_subTab == false) $(".tab-hidden").hide();
    ...
    $(document).ready(function () {
        $("." + _contentDataTab + " ul li a").click(function () {
            ...
            if (_subTab == false)
            {
                switch (_dropID)
                {
                    case "link-tab3-cp-tab-user"                              : { _action = $("#action").val(); _id = $("#username-hidden").val() + ":" + $("#password-hidden").val(); _trackingStatus = ""; break; }
                    case "link-tab3-cp-tab-program"                           :
                    case "link-tab3-cp-tab-interest"                          :
                    case "link-tab3-cp-tab-pay-break-contract"                :
                    case "link-tab3-cp-tab-scholarship"                       : { _action = $("#action").val(); _id = $("#cp1id").val(); _trackingStatus = ""; break; }
                    case "link-tab3-cp-trans-break-contract"                  : { _action = $("#action").val(); _id = $("#cp1id").val(); _trackingStatus = $("#trackingstatus").val(); break; }
                    case "link-tab3-cp-trans-require-contract"                : { _action = $("#action").val(); _id = $("#cp1id").val(); _trackingStatus = $("#trackingstatus").val(); break; }
                    case "link-tab2-cp-trans-payment"                         :
                    case "link-tab1-adddetail-cp-trans-payment"               : 
                    case "link-tab2-adddetail-cp-trans-payment"               :
                    case "link-tab2-cp-report-table-cal-capital-and-interest" : { _action = ""; _id = $("#cp2id").val(); _trackingStatus = ""; break; }
                }
            ...
            if (_subTab == true)
            {
                ...
                {
                    case "link-tab1-adddetail-cp-trans-payment" :
                    case "link-tab2-adddetail-cp-trans-payment" : { _action = ""; _id = $("#cp2id").val(); _trackingStatus = ""; break; }
                }
...
function LoadForm(_frmIndex, _frm, _dialogFrm, _frmID, _id, _idActive)
{
    ...
    LoadAjax(_send.join("&"), "Handler/eCPHandler.ashx", "POST", true, true, function (_result) {
        ...
        switch (_frm)
        {
            case "searchcptabuser"                           : { ResetFrmSearchCPTabUser(""); break; }
            case "addcptabuser"                              :
            case "updatecptabuser"                           : { ResetFrmCPTabUser(false); break; }
            case "addcptabprogram"                           :
            case "updatecptabprogram"                        : { ResetFrmCPTabProgram(false); break; } 
            case "addcptabinterest"                          :
            case "updatecptabinterest"                       : { ResetFrmCPTabInterest(false); break; }
            case "addcptabpaybreakcontract"                  :
            case "updatecptabpaybreakcontract"               : { ResetFrmCPTabPayBreakContract(false); break; }
            case "addcptabscholarship"                       :
            case "updatecptabscholarship"                    : { ResetFrmCPTabScholarship(false); break; }
            case "addprofilestudent"                         : { ResetFrmAddProfileStudent(); break; }
            case "searchstudentwithresult"                   : { ResetFrmSearchStudentWithResult(); break; }
            case "searchcptransbreakcontract"                : { ResetFrmSearchCPTransBreakContract(""); break; }            
            case "addcptransbreakcontract"                   :
            case "updatecptransbreakcontract"                : { ResetFrmCPTransBreakContract(false); break; }
            case "addcptransrequirecontract"                 :
            case "updatecptransrequirecontract"              : { InitStudyLeaveYesNo(); ResetFrmCPTransRequireContract(false); break; }
            case "searchcptransrepaycontract"                : { ResetFrmSearchCPTransRepayContract(""); break; }
            case "addupdaterepaycontract"                    : { ResetFrmCPTransRepayContract(false); break; }
            case "calinterest"                               : { ResetFrmCalInterestOverpayment(false); break; }
            case "selectformatpayment"                       : { ResetFrmSelectFormatPayment(); break; }
            case "adddetailcptranspayment"                   : { InitTab(true); ResetFormatPayment(); ResetListTransPayment(); break; }
            case "searchcptranspayment"                      : { ResetFrmSearchCPTransPayment(""); break; }
            case "detailcptranspayment"                      : { /*GoToElement("top-page");*/GoToTopElement("html, body"); ResetListTransPayment(); break; }
            case "addcptranspaymentfullrepay"                :
            case "addcptranspaymentpayrepay"                 : { InitCalInterestYesNo(); InitPayChannel(); ResetFrmAddCPTransPayment(); break; }
            case "detailtranspayment"                        : { ResetDetailTransPayment(); break; }
            case "adddetailpaychannel"                       : { ResetFrmAddDetailPayChannel(); break; }
            case "chkbalance"                                : { CalculateChkBalance(); break; }
            case "calreporttablecalcapitalandinterest"       : { /*GoToElement("top-page");*/GoToTopElement("html, body"); ResetFrmCalReportTableCalCapitalAndInterest(); break; }
            case "searchcpreporttablecalcapitalandinterest"  : { ResetFrmSearchCPReportTableCalCapitalAndInterest(""); break; }
            case "searchcpreportstepofwork"                  : { ResetFrmSearchCPReportStepOfWork(""); break; }
            case "reportstepofworkonstatisticrepaybyprogram" : { ResetFrmSearchReportStepOfWorkOnStatisticRepayByProgram(); break; }
            case "reportstudentonstatisticcontractbyprogram" : { InitTab(true); ResetFrmSearchReportStudentOnStatisticContractByProgram(); break; }
            case "searchcpreportnoticerepaycomplete"         : { ResetFrmSearchCPReportNoticeRepayComplete(""); break; }
            case "searchcpreportnoticeclaimdebt"             : { ResetFrmSearchCPReportNoticeClaimDebt(""); break; }
            case "searchcpreportpaymentbydate"               : { ResetFrmSearchCPReportStatisticPaymentByDate(""); break; }
            case "manual"                                    : { InitSlide(".class-dialog-form-manual .ui-dialog-content", _manual, true, "Manual/UserManual.zip"); break; }
            case "searchcpreportecontract"                   : { ResetFrmSearchCPReportEContract(""); break; }
            case "searchcpreportdebtorcontract"              : { ResetFrmSearchCPReportDebtorContract(""); break; }
            case "searchstudentdebtorcontractbyprogram"      : { ResetFrmSearchStudentDebtorContractByProgram(""); break; }
        }
...
{
    var _send = new Array();
    _send[0] = "currentpage=" + _currentPage;
    _send[1] = "startrow=" + _startRow;
    _send[2] = "endrow=" + _endRow;

    if (_pageContent == "tabuser")
    {
        _send[3] = "name=" + $("#name-tab-user-hidden").val();
    ...
    if (_pageContent == "studentwithresult")
    {
        ...
        _send[3] = "studentid=" + $("#id-name-search-student").val();
        _send[4] = "faculty=" + (_faculty[0] != null ? _faculty[0] : "");
        _send[5] = "programcode=" + (_program[0] != null ? _program[0] : "");
        _send[6] = "majorcode=" + (_program[2] != null ? _program[2] : "");
        _send[7] = "groupnum=" + (_program[3] != null ? _program[3] : "");
    ...
    if (_pageContent == "transbreakcontract")
    {
        ...
        _send[3] = "statussend=" + ($("#trackingstatus-trans-break-contract-hidden").val() == "1" ? "1" : ($("#trackingstatus-trans-break-contract-hidden").val() == "6" ? "1" : ""));
        _send[4] = "statusreceiver=" + ($("#trackingstatus-trans-break-contract-hidden").val() == "2" ? "1" : ($("#trackingstatus-trans-break-contract-hidden").val() == "3" ? "2" : ""));
        _send[5] = "statusedit=" + ($("#trackingstatus-trans-break-contract-hidden").val() == "4" ? "2" : ($("#trackingstatus-trans-break-contract-hidden").val() == "6" ? "2" : ""));
        _send[6] = "statuscancel=" + ($("#trackingstatus-trans-break-contract-hidden").val() == "5" ? "2" : ($("#trackingstatus-trans-break-contract-hidden").val() == "6" ? "2" : ""));
        _send[7] = "studentid=" + $("#id-name-trans-break-contract-hidden").val();
        _send[8] = "faculty=" + (_faculty[0] != null ? _faculty[0] : ""); ;
        _send[9] = "programcode=" + (_program[0] != null ? _program[0] : "");
        _send[10] = "majorcode=" + (_program[2] != null ? _program[2] : "");
        _send[11] = "groupnum=" + (_program[3] != null ? _program[3] : "");
        _send[12] = "datestart=" + $("#date-start-trans-break-contract-hidden").val();
        _send[13] = "dateend=" + $("#date-end-trans-break-contract-hidden").val();
    ...
    if (_pageContent == "transrepaycontract")
    {
        ...
        _send[3] = "statusrepay=" + _statusRepay[0];
        _send[4] = "statusreply=" + _statusRepay[1];
        _send[5] = "replyresult=" + _statusRepay[2];
        _send[6] = "statuspayment=" + _statusRepay[3];
        _send[7] = "studentid=" + $("#id-name-trans-repay-contract-hidden").val();
        _send[8] = "faculty=" + (_faculty[0] != null ? _faculty[0] : "");
        _send[9] = "programcode=" + (_program[0] != null ? _program[0] : "");
        _send[10] = "majorcode=" + (_program[2] != null ? _program[2] : "");
        _send[11] = "groupnum=" + (_program[3] != null ? _program[3] : "");
        _send[12] = "datestart=" + $("#date-start-trans-repay-contract-hidden").val();
        _send[13] = "dateend=" + $("#date-end-trans-repay-contract-hidden").val();
    ...
    if (_pageContent == "transpayment")
    {
        ...
        _send[3] = "statuspayment=" + $("#paymentstatus-trans-payment-hidden").val();
        _send[4] = "studentid=" + $("#id-name-trans-payment-hidden").val();
        _send[5] = "faculty=" + (_faculty[0] != null ? _faculty[0] : "");
        _send[6] = "programcode=" + (_program[0] != null ? _program[0] : "");
        _send[7] = "majorcode=" + (_program[2] != null ? _program[2] : "");
        _send[8] = "groupnum=" + (_program[3] != null ? _program[3] : "");
        //ปรับปรุงเมื่อ ๒๘/๐๓/๒๕๖๒
        //---------------------------------------------------------------------------------------------------
        _send[9] = "datestart=" + $("#date-start-trans-repay1-reply-hidden").val();
        _send[10] = "dateend=" + $("#date-end-trans-repay1-reply-hidden").val();
        //---------------------------------------------------------------------------------------------------
    ...
    if (_pageContent == "reporttablecalcapitalandinterest")
    {
        ...
        _send[3] = "studentid=" + $("#id-name-report-table-cal-capital-and-interest-hidden").val();
        _send[4] = "faculty=" + (_faculty[0] != null ? _faculty[0] : "");
        _send[5] = "programcode=" + (_program[0] != null ? _program[0] : "");
        _send[6] = "majorcode=" + (_program[2] != null ? _program[2] : "");
        _send[7] = "groupnum=" + (_program[3] != null ? _program[3] : "");
    ...
    if (_pageContent == "reportstepofwork")
    {
        ...
        _send[3] = "statusstepofwork=" + $("#stepofworkstatus-report-step-of-work-hidden").val();
        _send[4] = "studentid=" + $("#id-name-report-step-of-work-hidden").val();
        _send[5] = "faculty=" + (_faculty[0] != null ? _faculty[0] : "");
        _send[6] = "programcode=" + (_program[0] != null ? _program[0] : "");
        _send[7] = "majorcode=" + (_program[2] != null ? _program[2] : "");
        _send[8] = "groupnum=" + (_program[3] != null ? _program[3] : "");
    ...
    if (_pageContent == "reportstepofworkonstatisticrepaybyprogram")
    {
        ...
        _send[3] = "acadamicyear=" + $("#acadamicyear-hidden").val();
        _send[4] = "studentid=" + $("#id-name-search-report-step-of-work").val();
        _send[5] = "faculty=" + (_faculty[0] != null ? _faculty[0] : ""); ;
        _send[6] = "programcode=" + (_program[0] != null ? _program[0] : "");
        _send[7] = "majorcode=" + (_program[2] != null ? _program[2] : "");
        _send[8] = "groupnum=" + (_program[3] != null ? _program[3] : "");
    ...
    if (_pageContent == "reportstudentonstatisticcontractbyprogram")
    {
        ...
        _send[3] = "acadamicyear=" + $("#acadamicyear-hidden").val();
        _send[4] = "studentid=" + $("#id-name-search-report-student-contract").val();
        _send[5] = "faculty=" + (_faculty[0] != null ? _faculty[0] : ""); ;
        _send[6] = "programcode=" + (_program[0] != null ? _program[0] : "");
        _send[7] = "majorcode=" + (_program[2] != null ? _program[2] : "");
        _send[8] = "groupnum=" + (_program[3] != null ? _program[3] : "");
        _send[9] = "searchtab=" + _searchTab;
    ...
    if (_pageContent == "reportnoticerepaycomplete")
    {
        ...
        _send[3] = "studentid=" + $("#id-name-report-notice-repay-complete-hidden").val();
        _send[4] = "faculty=" + (_faculty[0] != null ? _faculty[0] : ""); ;
        _send[5] = "programcode=" + (_program[0] != null ? _program[0] : "");
        _send[6] = "majorcode=" + (_program[2] != null ? _program[2] : "");
        _send[7] = "groupnum=" + (_program[3] != null ? _program[3] : "");
    ...
    if (_pageContent == "reportnoticeclaimdebt")
    {
        ...
        _send[3] = "studentid=" + $("#id-name-report-notice-claim-debt-hidden").val();
        _send[4] = "faculty=" + (_faculty[0] != null ? _faculty[0] : "");
        _send[5] = "programcode=" + (_program[0] != null ? _program[0] : "");
        _send[6] = "majorcode=" + (_program[2] != null ? _program[2] : "");
        _send[7] = "groupnum=" + (_program[3] != null ? _program[3] : "");
    ...
    if (_pageContent == "reportstatisticpaymentbydate")
    {
        ...
        _send[3] = "studentid=" + $("#id-name-report-statistic-payment-by-date-hidden").val();
        _send[4] = "faculty=" + (_faculty[0] != null ? _faculty[0] : "");
        _send[5] = "programcode=" + (_program[0] != null ? _program[0] : "");
        _send[6] = "majorcode=" + (_program[2] != null ? _program[2] : "");
        _send[7] = "groupnum=" + (_program[3] != null ? _program[3] : "");
        _send[8] = "formatpayment=" + (_formatPayment[0] != null ? _formatPayment[0] : "");
        _send[9] = "datestart=" + $("#date-start-report-statistic-payment-by-date-hidden").val();
        _send[10] = "dateend=" + $("#date-end-report-statistic-payment-by-date-hidden").val();
    ...
    if (_pageContent == "reportecontract")
    {
        ...
        _send[3] = "acadamicyear=" + $("#acadamicyear-report-e-contract-hidden").val();
        _send[4] = "studentid=" + $("#id-name-report-e-contract-hidden").val();
        _send[5] = "faculty=" + (_faculty[0] != null ? _faculty[0] : "");
        _send[6] = "programcode=" + (_program[0] != null ? _program[0] : "");
        _send[7] = "majorcode=" + (_program[2] != null ? _program[2] : "");
        _send[8] = "groupnum=" + (_program[3] != null ? _program[3] : "");
        //_send[9] = "formatpayment=" + (_formatPayment[0] != null ? _formatPayment[0] : "");
    ...
    if (_pageContent == "reportdebtorcontractbyprogram")
    {
        ...
        _send[3] = "reportorder=" + _reportOrder;
        _send[4] = "datestart=" + $("#date-start-report-debtor-contract-hidden").val();
        _send[5] = "dateend=" + $("#date-end-report-debtor-contract-hidden").val();
        _send[6] = "studentid=" + $("#id-name-report-debtor-contract-by-program-hidden").val();
        _send[7] = "faculty=" + (_faculty[0] != null ? _faculty[0] : "");
        _send[8] = "programcode=" + (_program[0] != null ? _program[0] : "");
        _send[9] = "majorcode=" + (_program[2] != null ? _program[2] : "");
        _send[10] = "groupnum=" + (_program[3] != null ? _program[3] : "");
        _send[11] = "formatpayment=" + (_formatPayment[0] != null ? _formatPayment[0] : "");
...
function CloseFrm(_dialogFrm, _frmClose)
{
    ...
    switch (_frmClose)
    {
        case "addupdate-cp-tab-user"                     : { $("#link-tab1-cp-tab-user").click(); break; }
        case "addupdate-cp-tab-program"                  : { $("#link-tab1-cp-tab-program").click(); break; }
        case "addupdate-cp-tab-interest"                 : { $("#link-tab1-cp-tab-interest").click(); break; }
        case "addupdate-cp-tab-pay-break-contract"       : { $("#link-tab1-cp-tab-pay-break-contract").click(); break; }
        case "addupdate-cp-tab-scholarship"              : { $("#link-tab1-cp-tab-scholarship").click(); break; }
        case "addupdate-cp-trans-break-contract"         : { $("#link-tab1-cp-trans-break-contract").click(); break; }
        case "addupdate-cp-trans-require-contract"       : { $("#link-tab1-cp-trans-require-contract").click(); break; }
        case "add-cp-trans-payment"                      : { $("#link-tab1-adddetail-cp-trans-payment").click(); break; }
        case "cal-report-table-cal-capital-and-interest" : { $("#link-tab1-cp-report-table-cal-capital-and-interest").click(); break; }
    }
}
...
function CalculateInterestOverpayment()
{
    ...
    {        
        ...
        _send[1] = "overpaymentyear=" + DelCommas("overpayment-year");
        _send[2] = "overpaymentday=" + DelCommas("overpayment-day");
        _send[3] = "overpaymentinterest=" + DelCommas("overpayment-interest");
        _send[4] = "overpaymentdatestart=" + $("#overpayment-date-start").val();
        _send[5] = "overpaymentdateend=" + $("#overpayment-date-end").val();
        _send[6] = "totalinterestpayrepay=" + ($("#total-interest-pay-repay").length > 0 ? ($("#total-interest-pay-repay").val().length > 0 ? DelCommas("total-interest-pay-repay") : "0.00") : "0.00");
        _send[7] = "totalaccruedinterest=" + ($("#total-accrued-interest").length > 0 ? DelCommas("total-accrued-interest") : "0.00");
...
function CalculateInterestPayRepay()
{
    ...
    {        
        var _send = new Array();
        _send[0] = "capital=" + DelCommas("capital");
        _send[1] = "payrepayyear=" + DelCommas("pay-repay-year");
        _send[2] = "payrepayday=" + DelCommas("pay-repay-day");
        _send[3] = "payrepayinterest=" + DelCommas("pay-repay-interest");
        _send[4] = "payrepaydatestart=" + $("#pay-repay-date-start").val();
        _send[5] = "payrepaydateend=" + $("#pay-repay-date-end").val();
        _send[6] = "totalinterestoverpayment=" + ($("#total-interest-overpayment").length > 0 ? ($("#total-interest-overpayment").val().length > 0 ? DelCommas("total-interest-overpayment") : "0.00") : "0.00");
        _send[7] = "totalaccruedinterest=" + ($("#total-accrued-interest").length > 0 ? DelCommas("total-accrued-interest") : "0.00");
...
function CalculateInterestOverpaymentAndPayRepay()
{
    ...
    {        
        ...
        _send[4] = "overpaymentdatestart=" + $("#overpayment-date-start").val();
        _send[5] = "overpaymentdateend=" + $("#overpayment-date-end").val();
        _send[6] = "payrepayyear=" + DelCommas("pay-repay-year");
        _send[7] = "payrepayday=" + DelCommas("pay-repay-day");
        _send[8] = "payrepayinterest=" + DelCommas("pay-repay-interest");
        _send[9] = "payrepaydatestart=" + $("#pay-repay-date-start").val();
        _send[10] = "payrepaydateend=" + $("#pay-repay-date-end").val();
...
function CalculateChkBalance()
{
    var _send = new Array();
    _send[0] = "capital=" + DelCommas("capital");
    _send[1] = "totalinterest=" + DelCommas("total-interest");
    _send[2] = "totalaccruedinterest=" + DelCommas("total-accrued-interest");
    _send[3] = "totalpayment=" + DelCommas("total-payment");
    _send[4] = "pay=" + DelCommas("pay");
