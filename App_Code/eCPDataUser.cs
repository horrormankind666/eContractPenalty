...
public class eCPDataUser
{
    ...
    public static string TabCPTabUser()
    {
        ...
        _html += "<div id='cp-tab-user-head'>" +
                 ...
                 "                  <div class='box-search-condition-order-title'>ชื่อ</div><div class='box-search-condition-split-title-value'>:</div><div class='box-search-condition-order-value' id='search-tab-user-condition-order1-value'></div>" +
                 "                  <div class='clear'></div>" +
                 "              </div>" +                 
                 "          </div>" +
                 "      </div>" +
