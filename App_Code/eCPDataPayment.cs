...
public class eCPDataPayment
{
    ...
    public static string AddDetailCPTransPayment(string _cp2id, string _action)
    {
        ...
        if (_data.GetLength(0) > 0)
        {
            switch (_action)
            {
                case "detail"      : { _html = DetailCpTransPayment(_data); break; }
                case "addfullrepay": { _html = AddCpTransPaymentFullRepay(_data); break; }
                case "addpayrepay" : { _html = AddCpTransPaymentPayRepay(_data); break; }
            }
        }
        */
        int _i;
        ...
        if (_data1.GetLength(0) > 0)
        {
            ...
            switch (_action)
            {
                case "detail"      : { _html = DetailCpTransPayment(_data1); break; }
                case "addfullrepay": { _html = AddCpTransPaymentFullRepay(_data1); break; }
                case "addpayrepay" : { _html = AddCpTransPaymentPayRepay(_data1); break; }
            }
        }
