...
public class eCPDataPayment {
    ...
    public static string AddDetailPayChannel(string payChannel) {
        ...
        html += (
            ...
            "       </div>" +
            "       <div class='content-left'>" +
            "           <div class='form-input-style'><div class='form-input-content'><span>" + eCPUtil._payChannel[int.Parse(payChannel) - 1] + "</span></div></div>" +
            "      </div>" +
            "   </div>" +
            "   <div class='clear'></div>"
        );
    ...
    private static string FrmOverpayment(
        ...
        if (statusPayment.Equals("1")) {
            if ((overpaymentYear + overpaymentDay) > 0) {
                html += (
                    ...
                    "                   <div class='form-input-content-line'>ตั้งแต่วันที่ <span>" + Util.LongDateTH(repayDateStart) + "</span> ถึงวันที่ <span>" + Util.LongDateTH(repayDateEnd) + "</span></div>" +
                    "               </div>" +
                    "           </div>" +
                    "       </div>" +
                    "   </div>" +
        ...
        if (statusPayment.Equals("2") || (formatPayment.Equals("2") && (overpaymentYear + overpaymentDay) <= 0)) {
            html += (
    ...
    public static string DetailTransPayment(string cp2id) {
        ...
        if (data.GetLength(0) > 0) {
            ...
            string calInterestYesNoDefault = !String.IsNullOrEmpty(data[0, 2]) ? eCPUtil._calInterestYesNo[Util.FindIndexArray2D(1, eCPUtil._calInterestYesNo, data[0, 2]) - 1, 0] : String.Empty;
            ...
            */
            ...
            if (formatPayment.Equals("1")) {
                html += (
                    "               <div class='form-label-discription-style'><div class='form-label-style'>จำนวนเงินที่ชำระ</div></div>" +
            ...
            if (formatPayment.Equals("2")) {
                html += (
                    "               <div class='form-label-discription-style'><div class='form-label-style'>จำนวนเงินต้นคงเหลือที่ยกมา</div></div>" +
            ...
            html += (
                "               </div>" +
                "               <div class='content-left'>" +
                "                   <div class='form-input-style'><div class='form-input-content'><span>" + subtotalPenaltyDefault + "</span> บาท</div></div>" +
                "                   <div class='form-input-style'><div class='form-input-content'><span>" + totalPenaltyDefault + "</span> บาท</div></div>"
            );

            if (formatPayment.Equals("1")) {
                html += (
                    "               <div class='form-input-style'><div class='form-input-content'><span>" + totalPayDefault + "</span> บาท</div></div>" +
                    "               <div class='form-input-style'><div class='form-input-content'><span>" + overpaymentTotalInterestDefault + "</span> บาท</div></div>" +
                    "               <div class='form-input-style'><div class='form-input-content'><span>" + payCapitalDefault + "</span> บาท</div></div>" +
                    "               <div class='form-input-style'><div class='form-input-content'><span>" + overpayDefault + "</span> บาท</div></div>" +
                    "               <div class='form-input-style'><div class='form-input-content'><span>" + remainCapitalDefault + "</span> บาท</div></div>"
                );
            }

            if (formatPayment.Equals("2")) {
                html += (
                    "               <div class='form-input-style'><div class='form-input-content'><span>" + capitalDefault + "</span> บาท</div></div>" +
                    "               <div class='form-input-style'><div class='form-input-content'><span>" + totalAccruedInterestDefault + "</span> บาท</div></div>" +
                    "               <div class='form-input-style'><div class='form-input-content'><span>" + totalPayDefault + "</span> บาท</div></div>" +
                    "               <div class='form-input-style'><div class='form-input-content'><span>" + overpaymentTotalInterestBeforeDefault + "</span> บาท</div></div>" +
                    "               <div class='form-input-style'><div class='form-input-content'><span>" + payRepayTotalInterestDefault + "</span> บาท</div></div>" +
                    "               <div class='form-input-style'><div class='form-input-content'><span>" + overpaymentTotalInterestDefault + "</span> บาท</div></div>" +
                    "               <div class='form-input-style'><div class='form-input-content'><span>" + payCapitalDefault + "</span> บาท</div></div>" +
                    "               <div class='form-input-style'><div class='form-input-content'><span>" + overpayDefault + "</span> บาท</div></div>" +
                    "               <div class='form-input-style'><div class='form-input-content'><span>" + remainCapitalDefault + "</span> บาท</div></div>" +
                    "               <div class='form-input-style'><div class='form-input-content'><span>" + remainAccruedInterestDefault + "</span> บาท</div></div>"
                );
            }
            ...
            html += (
                ...
                "                   <div class='form-input-style'>" +
                "                       <div class='form-input-content'>" +
                "                           <div><span>" + eCPUtil._payChannel[int.Parse(channelDefault) - 1] + "</span></div>"
            );

            if (channelDefault.Equals("2")) {
                html += (
                    "                       <div class='form-input-content-line'>เลขที่เช็ค <span>" + chequeNoDefault + "</span></div>" +
                    "                       <div class='form-input-content-line'>ธนาคาร <span>" + chequeBankDefault + "</span></div>" +
                    "                       <div class='form-input-content-line'>สาขา <span>" + chequeBankBranchDefault + "</span></div>" +
                    "                       <div class='form-input-content-line'>วันที่บนเช็ค <span>" + chequeDateDefault + "</span></div>"
                );
            }

            if (channelDefault.Equals("3")) {
                html += (
                    "                       <div class='form-input-content-line'>ธนาคาร <span>" + cashBankDefault + "</span></div>" +
                    "                       <div class='form-input-content-line'>สาขา <span>" + cashBankBranchDefault + "</span></div>" +
                    "                       <div class='form-input-content-line'>ชื่อบัญชี <span>" + cashBankAccountDefault + "</span></div>" +
                    "                       <div class='form-input-content-line'>เลขที่บัญชี <span>" + cashBankAccountNoDefault + "</span></div>" +
                    "                       <div class='form-input-content-line'>วันที่บนใบนำฝาก <span>" + cashBankDateDefault + "</span></div>"
                );
            }
            ...
            html += (
                ...
                "                   <div class='form-input-style'>" +
                "                       <div class='form-input-content'>" +
                "                           <div>เลขที่ใบเสร็จ <span>" + receiptNoDefault + "</span></div>" +
                "                           <div class='form-input-content-line'>เล่มที่ <span>" + receiptBookNoDefault + "</span></div>" +
                "                           <div class='form-input-content-line'>ลงวันที่ <span>" + receiptDateDefault + "</span></div>" +
                "                           <div class='form-input-content-line'>เลขที่ใบนำส่ง <span>" + receiptSendNoDefault + "</span></div>" +
                "                           <div class='form-input-content-line'>เข้ากองทุน <span>" + receiptFundDefault + "</span></div>" +
                "                           <div class='form-input-content-line'>สำเนาใบเสร็จรับเงิน <span>" + (!String.IsNullOrEmpty(receiptCopyDefault) ? "<a class='text-underline' href='javascript:void(0)' onclick=DownloadReceiptCopy('" + receiptCopyDefault + "')>ดาว์นโหลดสำเนาใบเสร็จรับเงิน</a>" : "-") + "</span></div>"
            );
            ...
            html += (
                ...
                "               </div>" +
                "               <div class='content-left'>" +
                "                   <div class='form-input-style'><div class='form-input-content'>" + (!String.IsNullOrEmpty(lawyerDefault) ? lawyerDefault : "<span>-</span>") + "</div></div>" +
                "               </div>" +
                "           </div>" +
                "           <div class='clear'></div>" +
                "       </div>" +
                ...
                "           <ul>" +
                "               <li><a href='javascript:void(0)' onclick=doConfirmActionCPTransPayment('del','" + data[0, 0] + "')>ลบ</a></li>" +
                "               <li><a href='javascript:void(0)' onclick=CloseFrm(true,'')>ปิด</a></li>" +
                "           </ul>" +
                "       </div>" +
                "   </div>" +
    ...
    private static string DetailPenaltyAndFormatPayment(
        ...
        html += (
            ...
            "           <div class='form-input-style'><div class='form-input-content'><span>" + double.Parse(totalPayScholarshipDefault).ToString("#,##0.00") + "</span> บาท</div></div>" +
            "           <div class='form-input-style'><div class='form-input-content'><span>" + double.Parse(subtotalPenaltyDefault).ToString("#,##0.00") + "</span> บาท</div></div>" +
            "           <div class='form-input-style'><div class='form-input-content'><span>" + double.Parse(totalPenaltyDefault).ToString("#,##0.00") + "</span> บาท</div></div>" +
            "       </div>" +
            "   </div>" +
            "   <div class='clear'></div>" +
            "   <div>" +
            ...
            "           <div class='form-label-discription-style" + (!statusPayment.Equals("3") && showStatusPaymentRecord.Equals(false) ? " clear-bottom" : String.Empty) + "'><div class='form-label-style'>สถานะการชำระหนี้</div></div>" +
            "       </div>" +
            "       <div class='content-left' id='status-payment-input'>" +
            "           <div class='form-input-style" + (!statusPayment.Equals("3") && showStatusPaymentRecord.Equals(false) ? " clear-bottom" : String.Empty) + "'><div class='form-input-content'><span>" + eCPUtil._paymentStatus[int.Parse(statusPayment) - 1] + "</span></div></div>" +
            "       </div>" +
            "   </div>" +
            "   <div class='clear'></div>"
        );

        if (!statusPayment.Equals("3") && showStatusPaymentRecord.Equals(true)) {
            html += (
        ...
        if (statusPayment.Equals("3")) {
            html += (
                ...
                "       <div class='form-input-style clear-bottom'>" +
                "           <div class='form-input-content'>" +
                "               <span><a class='text-underline' href='javascript:void(0)' onclick=PrintCertificateReimbursement('" + cp2id + "')>พิมพ์หนังสือรับรองการชำระหนี้เรียบร้อย</a></span>" +
                "          </div>" +
                "       </div>" +
                "   </div>" +
                "</div>" +
    ...
    public static string AddDetailCPTransPayment(
        ...
        string html = String.Empty;
        string statusRepay = String.Empty;
        string[,] data1;
        string[,] data2;

        data1 = eCPDB.ListDetailPaymentOnCPTransRequireContract(cp2id);

        if (data1.GetLength(0) > 0) {
            statusRepay = data1[0, 6];

            data2 = eCPDB.ListCPTransRepayContractNoCurrentStatusRepay(cp2id, statusRepay);
    ...
    public static string TabAddDetailCPTransPayment(string cp2id) {
        ...
        data = eCPDB.ListDetailPaymentOnCPTransRequireContract(cp2id);
        ...
        if (data.GetLength(0) > 0) {
            ...
            if (!String.IsNullOrEmpty(lawyerFullnameDefault) && (!String.IsNullOrEmpty(lawyerPhoneNumberDefault) || !String.IsNullOrEmpty(lawyerMobileNumberDefault) && !String.IsNullOrEmpty(lawyerEmailDefault))) {
                lawyerDefault += (
            ...
            html += (
                ...
                "       <div class='content-left' id='picture-student'><div><img src='Handler/eCPHandler.ashx?action=resize&file=" + eCPUtil.URL_PICTURE_STUDENT + pictureFolderNameDefault + "/" + pictureFileNameDefault + "&width=" + eCPUtil.WIDTH_PICTURE_STUDENT + "&height=" + eCPUtil.HEIGHT_PICTURE_STUDENT + "' /></div></div>" +
                ...
                "           <div class='form-label-discription-style'><div class='form-label-style'><span>" + studentIDDefault + "&nbsp;" + programCodeDefault.Substring(0, 4) + " / " + programCodeDefault.Substring(4, 1) + "</span></div></div>" +
                "           <div class='form-label-discription-style'><div class='form-label-style'><span>" + titleNameDefault + firstNameDefault + " " + lastNameDefault + "</span></div></div>" +
                "           <div class='form-label-discription-style'><div class='form-label-style'><span>" + dlevelDefault + "</span></div></div>" +
                "           <div class='form-label-discription-style'><div class='form-label-style'><span>" + facultyCodeDefault + " - " + facultyNameDefault + "</span></div></div>" +
                "           <div class='form-label-discription-style'><div class='form-label-style'><span>" + programCodeDefault + " - " + programNameDefault + (!groupNumDefault.Equals("0") ? " ( กลุ่ม " + groupNumDefault + " )" : "") + "</span></div></div>" +
                "           <div class='form-label-discription-style clear-bottom'><div class='form-label-style'>" + lawyerDefault + "</div></div>" +
                "       </div>" +
                "   </div>" +
                "   <div class='clear'></div>" +
                "   <div class='box3'></div>" +
    ...
    public static string ListPaymentOnCPTransRequireContract(HttpContext c) {
        ...
        int recordCount;
        int i;
        int[] resultPage = new int[2];
        int currentPage;

        recordCount = eCPDB.CountPaymentOnCPTransRequireContract(c);

        if (recordCount > 0) {
            data = eCPDB.ListPaymentOnCPTransRequireContract(c);
            ...
            for (i = 0; i < data.GetLength(0); i++) {
                ...
                if (!pid.Equals(20) && !pid.Equals(6))
                    callFunc = ("ChkSelectFormatPayment('" + data[i, 1] + "','" + data[i, 15] + "','" + data[i, 16] + "')");

                iconStatus = eCPUtil._iconPaymentStatus[int.Parse(data[i, 15]) - 1];
                
                html += (
                    "<ul class='table-row-content " + highlight + (String.IsNullOrEmpty(callFunc) ? " noclick" : String.Empty) + "' id='trans-payment" + data[i, 1] + "'>" +
                    "   <li id='table-content-cp-trans-payment-col1' onclick=" + callFunc + "><div>" + double.Parse(data[i, 0]).ToString("#,##0") + "</div></li>" +
                    "   <li class='table-col' id='table-content-cp-trans-payment-col2' onclick=" + callFunc + "><div>" + data[i, 3] + "</div></li>" +
                    "   <li class='table-col' id='table-content-cp-trans-payment-col3' onclick=" + callFunc + "><div>" + data[i, 4] + data[i, 5] + " " + data[i, 6] + "</div></li>" +
                    "   <li class='table-col' id='table-content-cp-trans-payment-col4' onclick=" + callFunc + "><div><span class='programcode-col'>" + data[i, 7] + "</span>- " + data[i, 8] + groupNum + "</div></li>" +
                    "   <li class='table-col' id='table-content-cp-trans-payment-col5' onclick=" + callFunc + "><div>" + data[i, 22].Replace(",", "<br />") + "</div></li>" +
                    "   <li class='table-col' id='table-content-cp-trans-payment-col6' onclick=" + callFunc + "><div>" + double.Parse(data[i, 19]).ToString("#,##0.00") + "</div></li>" +
                    "   <li class='table-col' id='table-content-cp-trans-payment-col7' onclick=" + callFunc + "><div>" + double.Parse(data[i, 23]).ToString("#,##0.00") + "</div></li>" +
                    "   <li class='table-col' id='table-content-cp-trans-payment-col8' onclick=" + callFunc + "><div>" + double.Parse(data[i, 24]).ToString("#,##0.00") + "</div></li>" +
                    "   <li class='table-col' id='table-content-cp-trans-payment-col9' onclick=" + callFunc + "><div>" + double.Parse(data[i, 25]).ToString("#,##0.00") + "</div></li>" +
                    "   <li class='table-col' id='table-content-cp-trans-payment-col10' onclick=" + callFunc + "><div>" + double.Parse(data[i, 26]).ToString("#,##0.00") + "</div></li>" +
                    "   <li class='table-col' id='table-content-cp-trans-payment-col11' onclick=" + callFunc + "><div>" + double.Parse(data[i, 27]).ToString("#,##0.00") + "</div></li>" +
            ...
            currentPage = (String.IsNullOrEmpty(c.Request["currentpage"]) ? 0 : int.Parse(c.Request["currentpage"]));
            resultPage = PageNavigate.CalPage(recordCount, currentPage, eCPUtil.ROW_PER_PAGE);
            pageHtml += (
        ...
        return ("<recordcount>" + recordCount.ToString("#,##0") + "<recordcount><list>" + html + "<list><pagenav>" + pageHtml + "<pagenav>");
    }
