...
public class eCPDB
{
    ...
    public static string[,] ListCPReportEContract(HttpContext _c)
    {
        ...
        foreach (DataRow _dr in _ds.Tables[1].Rows)
        {
            ...
            if (_dr["ProgramCode"].Equals("NSNSB"))
            {
                ...
                {
                    case "350"  :   { _p = _p + "_Chulabhorn"; break; }   
                    case "391"  :   { _p = _p + "_MT"; break; }
                }
            }
    ...
    public static int CountCPReportDebtorContract(HttpContext _c)
    {
        ...
        {
            case "reportdebtorcontract"         : { _orderTable = 43; break; }
            case "reportdebtorcontractpaid"     : { _orderTable = 45; break; }
            case "reportdebtorcontractremain"   : { _orderTable = 47; break; }
        }
    ...
    public static int CountCPReportDebtorContractByProgram(HttpContext _c)
    {
        ...
        switch (_c.Request["reportorder"])
        {
            case "reportdebtorcontract"         : { _orderTable = 44; break; }
            case "reportdebtorcontractpaid"     : { _orderTable = 46; break; }
            case "reportdebtorcontractremain"   : { _orderTable = 48; break; }
        }
